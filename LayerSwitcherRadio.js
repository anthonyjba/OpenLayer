      ...
      redraw: function () {
          ...
          for (var i = 0; i < layers.length; i++) {
              ...
              if (layer.displayInLayerSwitcher) {
                  ...
                  var sliderOpacity = document.createElement("div");
                  sliderOpacity.setAttribute("id", "slider_" + layer.id);
                  sliderOpacity.setAttribute("style", "margin-left:25px");
                  console.log(layer.id);

                  //Create the opacity slider for each layer                  
                  var slider = new Ext.Slider({
                      renderTo: sliderOpacity,
                      id: "ctrlSlider-" + map.layers[i].id,
                      width: 70,
                  ...
                  //                  groupDiv.appendChild(opacityMinusButton);
                  //                  groupDiv.appendChild(opacityImg);
                  //                  groupDiv.appendChild(opacitySpan);
                  //                  groupDiv.appendChild(opacityTextInput);
                  //                  groupDiv.appendChild(opacityPlusButton);
                  groupDiv.appendChild(sliderOpacity);
                  //                  groupDiv.appendChild(br);
                  ...
                  slider.on('change', function (slide, newValue) {
                      var idLayer = slide.id.substring(slide.id.indexOf('-') + 1, slide.id.length);
                  ...
                  /*
                  var slider = new Ext.Slider({
                  renderTo: "slider_" + layer.id,
                  width: 100,
                  value: 100,
                  listeners: {
                  change: function (el, val) {
                              
                  //this.changeLayerOpacity(opacityMinusContext);
                  //map.getLayersByName(layer.name)[0].setOpacity(val / 100);
                  }
                  }
                  });*/
